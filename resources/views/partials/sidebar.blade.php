<aside class="sidebar">
    ...
    <div class="nav-section">
        ...
        <a href="{{ route('admin.koreksi-absen.index') }}" class="nav-item {{ request()->routeIs('admin.koreksi-absen.*') ? 'active' : '' }}">
    ...
    <div class="nav-section">
        ...
        <a href="{{ route('admin.assessments.index') }}" class="nav-item {{ request()->routeIs('admin.assessments.index') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
            </svg>
            Penilaian Karyawan
        </a>
        <a href="{{ route('admin.assessments.report') }}" class="nav-item {{ request()->routeIs('admin.assessments.report') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
            </svg>
            Laporan Penilaian
        </a>
        <a href="{{ route('admin.assessment-categories.index') }}" class="nav-item {{ request()->routeIs('admin.assessment-categories.*') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
