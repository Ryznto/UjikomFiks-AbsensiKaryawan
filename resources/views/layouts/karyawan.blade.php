...
<body>
    <div class="app-mobile">
        ...
        <header class="mobile-header">
            <div class="mobile-header-left">
                ...
                <div>
                    ...
                    <div class="mobile-header-sub">{{ auth()->user()->karyawan->nama ?? '' }}</div>
                </div>
            </div>
        ...
        <nav class="bottom-nav">
            ...
            {{-- Rapor Penilaian --}}
            <a href="{{ route('karyawan.assessments.my-report') }}" class="bottom-nav-item {{ request()->routeIs('karyawan.assessments.*') ? 'active' : '' }}">
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
