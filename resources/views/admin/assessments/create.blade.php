    ...
    <div class="card" style="margin-bottom:20px;">
        ...
        <div style="padding:0 20px 20px; display:flex; flex-direction:column; gap:16px;">
            ...
            <div class="statement-item" id="card-{{ $statement->id }}"
                style="border:1px solid #e5e7eb; border-radius:12px; padding:16px 20px; transition:border-color 0.2s; {{ $existingScore ? 'border-color:#22c55e; background:rgba(34,197,94,0.1);' : '' }}">
