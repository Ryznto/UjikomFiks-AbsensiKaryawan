...
@section('page-sub', $shift->nama_shift)
...
<div class="card" style="max-width: 520px;">
    <div class="card-header">
        <div class="card-title">Edit — {{ $shift->nama_shift }}</div>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.shift.update', $shift) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="number" name="toleransi_terlambat" class="form-control"
                    value="{{ old('toleransi_terlambat', $shift->toleransi_terlambat) }}" min="0">
