<aside class="sidebar">
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.karyawan.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.karyawan.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?php echo e(route('admin.presensi.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.presensi.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.izin-cuti.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.izin-cuti.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.point-rules.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.point-rules.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
        ...
        <a href="<?php echo e(route('admin.flexibility-items.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.flexibility-items.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?php echo e(route('admin.leaderboard')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.leaderboard') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.assessments.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.assessments.index') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
        ...
        <a href="<?php echo e(route('admin.assessments.report')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.assessments.report') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
                    d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
        ...
        <a href="<?php echo e(route('admin.assessment-categories.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.assessment-categories.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
    ...
    <div class="nav-section">
        ...
        <a href="<?php echo e(route('admin.divisi.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.divisi.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
        ...
        <a href="<?php echo e(route('admin.jabatan.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.jabatan.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path
        ...
        <a href="<?php echo e(route('admin.shift.index')); ?>"
            class="nav-item <?php echo e(request()->routeIs('admin.shift.*') ? 'active' : ''); ?>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<?php /**PATH C:\laragon\www\absensi-karyawan\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>