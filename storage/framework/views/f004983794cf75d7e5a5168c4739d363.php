...
<?php $__env->startSection('page-title', 'Tambah Jabatan'); ?>
<?php $__env->startSection('page-sub', 'Buat jabatan baru'); ?>
...
<div class="card" style="max-width: 520px;">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.jabatan.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label class="form-label">Nama Jabatan <span style="color:var(--red)">*</span></label>
                <input type="text" name="nama_jabatan" class="form-control"
                    value="<?php echo e(old('nama_jabatan')); ?>" placeholder="Contoh: Backend Developer" autofocus>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\absensi-karyawan\resources\views/admin/jabatan/create.blade.php ENDPATH**/ ?>