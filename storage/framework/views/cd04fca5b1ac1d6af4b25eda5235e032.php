...
<div class="card fade-in" style="margin-bottom:16px; text-align:center;">
    <div class="card-body" style="padding:24px;">
        <div style="font-size:12px; color:var(--mid); margin-bottom:8px;">Rata-rata Nilai – <?php echo e($period); ?></div>
        ...
        <div style="margin-top:12px;">
            <span class="badge badge-<?php echo e($currentAssessment->score_badge); ?>" style="font-size:0.9rem; padding:6px 16px;">
