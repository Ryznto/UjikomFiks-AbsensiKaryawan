                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td style="font-weight:600; font-size:0.9rem;">
                                <?php echo e($cat->statements->count()); ?> pernyataan
                            </td>
                            </td>
                            </td>
                            ...
                            <td>
                                <div style="display:flex; gap:6px; align-items:center; flex-wrap:wrap;">
                                    <button
                                        onclick="openStatements(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>', <?php echo e($cat->statements->toJson()); ?>)"
                                    ...
                                    <button
                                        onclick="openEdit(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>', '<?php echo e(addslashes($cat->description)); ?>', <?php echo e($cat->max_score); ?>)"
                                    ...
                                    <form action="<?php echo e(route('admin.assessment-categories.toggle', $cat)); ?>" method="POST"
                                        style="display:inline;">
                                        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                        <button type="submit"
                                            style="padding:6px 14px; background:<?php echo e($cat->is_active ? '#f59e0b' : '#22c55e'); ?>; color:white; border:none; border-radius:8px; cursor:pointer; font-size:0.8rem; font-weight:600;">
                                            <?php echo e($cat->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>

                                        </button>
                                    </form>
                                    <form action="<?php echo e(route('admin.assessment-categories.destroy', $cat)); ?>" method="POST"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function deleteStatement(id) {
            ...
            form.innerHTML =
                `<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"><input type="hidden" name="_method" value="DELETE">`;
